...
export default function HeroCarousel() {
  ...
  return (
    <div
      className="w-full   mx-auto  2xl:px-6 "
      style={{
        backgroundImage:
          'url("data:image/svg+xml;base64,")',
        backgroundBlendMode: "overlay",
    ...
    >
      ...
      <div className="text-center pb-6">
        <h1 className="text-3xl px-2 md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-lime-300 to-green-500 drop-shadow-lg tracking-tight leading-snug animate-pulse">
